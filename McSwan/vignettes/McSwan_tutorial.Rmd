...
# Install McSwan package
```{r message=F, eval=F}
# install.packages("devtools")
require(devtools)
install_github(repo = "sunyatin/McSwan/McSwan", ref = "b96f64d")
```
...
ms <- paste("80", # total number of sampled chromosomes
            ...
            "-t",4*No*mut, # population mutation rate $\theta$ = 4*No*µ
...
If you encounter any bug or problem, please contact remi (dot) tournebize (at) ird (dot) fr
