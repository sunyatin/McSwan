...
#' @description Semi-automatic initialization of the prior distributions for all model parameters.
#' @param nSimul (integer) number of simulations to perform for each model (the larger, the better but beware memory usage! previous tests suggested that 20.000 were sufficient for moderately complex demographic scenarios)
...
#' @param windowSize (integer) length of the sequences (in bp) to simulate, the larger the better (> 100.000)
